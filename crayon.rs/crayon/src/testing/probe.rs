//! Coarse spatial assertions over readback pixels ("artboard-2 center is red,
//! the gap between artboards is clear-color") — immune to the sub-pixel and
//! driver-level nondeterminism that makes golden-image diffs flaky.
